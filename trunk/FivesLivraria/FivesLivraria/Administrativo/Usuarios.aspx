        ...
        function confirm(obj) {
            if (!confirmed) {
                $.msgBox({
                    ...
                    content: "Deseja realmente remover o usuário selecionado?",
                    type: "confirm",
    ...
    <div class="divForm">
        ...
        <div>
            <div style="padding-top: 7px;">
                ...
                <cc1:PagedGridView ID="gridUsuarios" runat="server" AutoGenerateColumns="false" 
                    Width="98%" AllowPaging="true"
                    OnRowCancelingEdit="gridUsuarios_RowCancelingEdit" OnRowDeleting="gridUsuarios_RowDeleting"
                    OnRowEditing="gridUsuarios_RowEditing"
                    OnRowUpdating="gridUsuarios_RowUpdating" PageSize="10" 
